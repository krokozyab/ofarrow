#!/bin/bash
# Oracle Fusion Flight SQL Server GUI - macOS/Linux Startup Script
...
echo -e "${BLUE}🛩️  Oracle Fusion Flight SQL Server GUI${NC}"
echo ""
...
echo -e "${GREEN}🚀 Starting Flight SQL Server GUI...${NC}"
