...
🖥️ **Built-in SQL Editor & Export** - Execute ad-hoc SQL queries using the integrated editor with database exploer, syntax highlightings, autocompletion and result previews, export results directly to CSV or Excel with one click.   
